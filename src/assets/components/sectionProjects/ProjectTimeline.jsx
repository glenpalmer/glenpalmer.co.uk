                  ...
                  {project.position === "left" ? (
                    <div className="flex">
                      ...
                      <div className="w-1/2 ml-4">
                        <div className="flex relative h-full items-start pl-8">
                          ...
                          <div className="flex flex-col items-start after:absolute after:h-3 after:w-3 after:bg-indigo-600 after:border-3 after:border-slate-50 after:rounded-full after:box-content after:-left-6 after:translate-y-2 group-last:before:hidden before:absolute before:-left-3.75 before:h-full before:px-px before:bg-slate-300 before:-translate-x-1/2 before:translate-y-3">
                  ...
                  {project.position === "right" ? (
                    <div className="flex">
                      <div className="w-1/2 mr-4">
                        <div className="flex relative h-full justify-end pr-8">
                          ...
                          <div className="flex flex-col items-end after:absolute after:h-3 after:w-3 after:bg-indigo-600 after:border-3 after:border-slate-50 after:rounded-full after:box-content after:-right-6.5 after:translate-y-2 group-last:before:hidden before:absolute before:-right-4.75 before:h-full before:px-px before:bg-slate-300 before:-translate-x-1/2 before:translate-y-3">
